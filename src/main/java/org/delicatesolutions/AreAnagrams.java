 ...
 * of one another because "its" is a rearrangement of all the letters of "sit" and vice versa. Write a
 * function that accepts two character arrays and returns 1 if they are anagrams of one another,
 * otherwise it returns 0. For simplicity, if the two input character arrays are equal, you may consider
 * them to be anagrams.
 ...
 * keep track of each letter that is found so that you don't count the same letter twice (e.g., the
