...
/*
A Meera array is an array that contains the value 1 if and only if it contains 9. The array {7, 9, 0, 10, 1} is a Meera
array because it contains 1 and 9. The array {6, 10, 8} is a Meera array because it contains no 1 and also contains no 9.
The array {7, 6, 1} is not a Meera array because it contains 1 but does not contain a 9. The array {9, 10, 0} is not a
Meera array because it contains a 9 but does not contain 1.
...
public class IsMeera5 {
    ...
    public static int isMeera(int[] a) {
        boolean isContainOne = false, isContainNine = false;
        for (int j : a) {
            if (j == 1) {
                isContainOne = true;
            }
        ...
        return isContainOne == isContainNine ? 1 : 0;
    }
